...
\begin{frame}[fragile]{{\color{violet}\texttt{simp}} and confluence}

The way in which {\color{violet}\verb`simp`} converts LHS to RHS leads to questions of {\color{violet}\verb`confluence`}.
\end{frame}
