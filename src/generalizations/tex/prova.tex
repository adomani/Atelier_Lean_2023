...
\[
  \left[ \;
  \makebox{\parbox{0.8\textwidth}{\small
  Being a ``{\texttt{simp}}-lemma'' is just something that you must communicate to Lean: there is no automated mechanism that makes Lean self-select which lemmas are {\texttt{simp}}-lemmas.
  }}
  \; \right]
\]
\bigskip
